...
\begin{figure}[tb]
  ...
  \begin{tikzpicture}[
    ...
    \node[BN] (b6) at (60bp,-75bp) {\includegraphics[width=0.5cm,trim=0 20 0 20,clip]{figures/duck.png}};
    \node[BN] (b7) at (110bp,-75bp) {\includegraphics[width=0.5cm,trim=0 20 0 20,clip]{figures/shorebird.png}};
    ...
    \draw[LL] (l3) -- (fit3);
  \end{tikzpicture}
  \caption{Birdwatching maximum cover example. \todo{Fix.}}\label{fig:toy}
\end{figure}
...
Our proofs generalize the results of \citet{buchbinder14} for the random greedy algorithm, and are presented in detail in the long version of this paper;\footnote{\todo{add link}} in what follows, we provide an outline of our analysis.
