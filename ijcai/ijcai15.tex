...
In practice, while adaptive submodularity provides an intuitive ``diminishing returns'' property for the adaptive setting, and is satisfied by a number of objective functions of interest, the additional assumption of adaptive monotonicity is often unrealistic.
