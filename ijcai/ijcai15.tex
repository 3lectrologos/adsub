...
%  \vspace{\scspacey}
  \caption{(\maxcut{} -- \fbook) The budget $k$ required by adaptive random greedy to reach a certain objective value (here $1900$) is considerably smaller compared to its non-adaptive counterpart.}
  \label{fig:fs_ego_fb}
\end{figure}
