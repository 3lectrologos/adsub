...
We focus here on the independent cascade model, according to which, each edge of the graph is randomly set ``live'' or ``blocked'', independent of any other edge in the network, and influence can only flow along ``live'' edges.
...
\setlength\figureheight{0.22\textwidth}
